...
const ForgetPassword = () => {
  ...
  return (
    <div className="w-full  h-full md:h-screen md:flex justify-around ">
      <div className="w-full md:w-[600px] mx-auto border-shadow rounded-md md:my-28 h-[500px] place-content-center p-5  bg-white md:mx-10">
        <div className="">
          ...
          >
            ...
            <Form.Item>
              <button
                ...
                border
                type="submit"
                className="w-full bg-[#778beb] text-xl font-semibold text-white rounded-md py-2"
              >
